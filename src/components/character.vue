<template>
    ...
    <p class="text hero" v-if="props.CharaData.character == 'hero'">{{ props.CharaData.num }}</p>
    ...
    <p class="text npc" v-if="props.CharaData.character != 'hero'">{{ props.CharaData.formula }}{{ props.CharaData.num }}</p>
</template>
<script setup>
